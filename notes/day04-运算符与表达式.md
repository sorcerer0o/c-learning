...
## 自测
  ...
  1. 运算符优先级记不住怎么办？写出表达式时应该怎么做？
  2. 什么是短路求值？&& 和 || 分别在什么情况下短路？
  3. i++ 和 ++i 的区别是什么？
  4. C 语言中什么值为假？什么值为真？
  5. break、continue、return 三者的区别是什么？
  6. 隐式类型转换中整数提升指的是什么？
  7. 无符号和有符号混用时可能有什么问题？如何避免？
  8. 逗号表达式 (a, b, c) 的值是什么？
  9. typedef 的作用是什么？有什么命名规范？
  10. sizeof 是否会计算括号内的表达式？举例说明。
