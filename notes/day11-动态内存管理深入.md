...
## 自测
  ...
  1. free 释放的是什么？释放后为什么建议置 NULL？
  2. 重复 free 同一块内存会怎样？
  3. calloc 和 malloc 有什么区别？calloc 相比 malloc+memset 有什么优势？
  4. realloc 的工作原理是什么？扩展失败会怎样？
  5. realloc 的正确用法是什么？arr = realloc(arr, ...) 有什么问题？
  6. free(NULL) 安全吗？为什么？
  7. 什么是内存泄漏？如何检测和避免？
  8. 什么是悬空指针？free 后指针的值是什么？
  9. 动态数组的扩容策略是什么？为什么是均摊 O(1)？
  10. 使用动态内存时最常见的三个错误是什么？
