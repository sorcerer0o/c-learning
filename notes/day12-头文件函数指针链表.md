...
## 自测
  ...
  1. 头文件保护为什么要用 #ifndef/#define/#endif？不加会怎样？
  2. 函数指针如何声明？用途有哪些？
  3. qsort 的 cmp 回调函数的参数和返回值是什么含义？
  4. 链表头插法为什么需要二级指针？用套壳写法如何避免？
  5. 链表反转的迭代思路是什么？需要几个指针？
  6. 如何判断链表是否有环？
  7. 链表和数组在插入/删除/查找上的时间复杂度各是多少？
  8. 栈和队列的特点分别是什么？各自适合什么场景？
  9. 头插法和尾插法各自的数据顺序是怎样的？
  10. 如果链表节点的 malloc 失败，应该怎么处理？
