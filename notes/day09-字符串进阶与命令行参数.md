...
## 自测
  ...
  1. argc 和 argv 分别代表什么？argv[0] 是什么？
  2. scanf 的 %s 有什么安全问题？如何安全地读取字符串？
  3. fgets 和 scanf 有什么区别？fgets 会保留什么？
  4. 如何去除 fgets 读取字符串末尾的换行符？
  5. 字符串数组用二维 char 数组和指针数组分别存在哪个内存区域？
  6. strtok 会修改原字符串吗？能否对字符串字面量使用 strtok？
  7. atoi 和 strtol 有什么区别？哪个更安全？
  8. memcpy 和 memmove 有什么区别？什么场景用 memmove？
  9. strchr 和 strrchr 有什么区别？
  10. 如何遍历 argv 数组？它的最后一个元素是什么？
